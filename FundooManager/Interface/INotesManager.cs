...
namespace FundooManager.Interface
{
    ...
    public interface INotesManager
    {
        ...
        /// <returns>returns string after setting remainder</returns>
        ...
        /// </summary>
        /// <param name="notesId">The notes identifier.</param>
        /// <returns>returns string after deleting note and adding to trash</returns>
        ...
        /// </summary>
        /// <param name="userId">The user identifier.</param>
        /// <returns>returns string after getting remainder notes</returns>
        ...
        /// </summary>
        /// <param name="userId">The user identifier.</param>
        /// <returns>returns string after getting archive notes</returns>
